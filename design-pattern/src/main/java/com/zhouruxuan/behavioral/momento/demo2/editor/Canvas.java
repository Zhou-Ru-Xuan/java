...
import com.zhouruxuan.behavioral.momento.demo2.commands.ColorCommand;
import com.zhouruxuan.behavioral.momento.demo2.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                com.zhouruxuan.behavioral.momento.demo2.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
